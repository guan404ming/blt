...
On English-to-Chinese translation ($n{=}100$), iterative refinement reduces syllable error by 86\% and achieves stronger rhyme preservation (ARI 0.36) than a supervised baseline (ARI 0.002), while requiring no parallel data and supporting 100+ languages.
\end{abstract}
